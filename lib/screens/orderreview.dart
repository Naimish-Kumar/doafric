                          ...
                          for (int i = 0; i < data.length; i++) {
                            total = total +
                                (double.parse(
                                    ...
                                    data[i]['qty']);
                            tax = tax + double.parse(data[i]['product']['tax']);
                          }
                            ...
                            children: [
                              ListView.builder(
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  SqliteDatabase.writeData(StorageKeys.title,
                                      data[index]['product']['title']);
                                  SqliteDatabase.writeData(StorageKeys.imageurl,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        country.toString() + state.toString(),
                                        style: const TextStyle(
                                            fontSize: 14,
                                            fontFamily: 'Amazon',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    StringFile.signDollar + total.toString(),
                                    textAlign: TextAlign.start,
                                    style: TextStyle(
                                      fontFamily: 'Amazon',
                                      color: colorBlack,
